    ...
    <div className="bg-white dark:bg-[#24283b] rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
      <div className="p-6 flex-grow">
        ...
        <div className="flex flex-wrap gap-2">
          {project.tech.map((tech, index) => (
            <span key={index} className="bg-blue-100 text-blue-800 dark:bg-dark-blue/20 dark:text-dark-blue text-xs font-medium px-2.5 py-0.5 rounded-full">
              {tech}
            </span>
          ))}
        </div>
      ...
      <div className="p-6 pt-0 mt-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          {project.links?.repo && (
            <a href={project.links.repo} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
