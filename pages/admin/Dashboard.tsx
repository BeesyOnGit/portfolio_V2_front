...
type AdminPage = "info" | "experience" | "projects" | "technologies";
    ...
    const NavItem: React.FC<{ page: AdminPage; children: React.ReactNode }> = ({ page, children }) => (
        <button
            ...
            className={`w-full text-left px-4 py-2 rounded-md transition-colors ${
                activePage === page ? "bg-blue-600 text-white" : "hover:bg-gray-200 dark:hover:bg-gray-700"
            }`}
        >
            {children}
        </button>
        ...
        <div className="flex min-h-screen bg-gray-100 dark:bg-dark-bg">
            <aside className="w-64 bg-white dark:bg-[#24283b] shadow-md flex flex-col p-4">
                ...
                <nav className="flex flex-col gap-2">
                    ...
                    <NavItem page="technologies">Technologies</NavItem>
                </nav>
                <div className="mt-auto space-y-2">
                    <button onClick={() => navigate("/")} className="w-full bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        Back to Portfolio
                    </button>
