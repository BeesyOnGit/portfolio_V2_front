...
import { SkeletonExperienceList } from "../components/skeletons/SkeletonExperience";

const Experience: React.FC = () => {
    const { experienceData, isLoadingExperience } = useAppContext();

    if (isLoadingExperience) {
        return (
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold mb-8 text-center dark:text-dark-cyan">Work Experience</h1>
                <SkeletonExperienceList />
            </div>
        );
    }
